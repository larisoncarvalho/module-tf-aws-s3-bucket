...
"$1" import -var-file environments/sg.tfvars 'module.service_account_key["service_account_key_2"].google_service_account_key.this["service_account_key_2"]' 'projects/597595105496/serviceAccounts/sg-prod-gcp@stackguardian-nonprod.iam.gserviceaccount.com/keys/115a703bdf0f0b9fa2a0eb3ce930abf5a11328a1'