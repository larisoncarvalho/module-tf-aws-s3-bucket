...
"$TF_BIN_PATH" import -var-file=environments/terraform.tfvars 'module.iam_role.aws_iam_role_policy_attachment.this["arn:aws:iam::aws:policy/aws-service-role/AutoScalingServiceRolePolicy"]' 'AWSServiceRoleForAutoScaling/arn:aws:iam::aws:policy/aws-service-role/AutoScalingServiceRolePolicy'
