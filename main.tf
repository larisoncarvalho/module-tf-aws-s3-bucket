module "neha_private_runner_asg" {
  ...
  availability_zones                    = var.neha_private_runner_asg.availability_zones
  ...
  new_instances_protected_from_scale_in = var.neha_private_runner_asg.new_instances_protected_from_scale_in
  service_linked_role_arn               = var.neha_private_runner_asg.service_linked_role_arn
