...
| `stulyze_app_name` | `string` | CloudFormation stack name for the Stulyze application | `"stulyze-app"` |
| `stulyze_app_disable_rollback` | `bool` | Set to true to disable rollback of the stack if stack creation failed | `false` |
