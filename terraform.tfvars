nonprod_euc1_enabled             = true
nonprod_euc1_comment             = "non-prod-euc1"
nonprod_euc1_aliases             = ["sg-nonprod-euc1.qa.stackguardian.io", "dash.qa.stackguardian.io"]
nonprod_euc1_default_root_object = "index.html"
nonprod_euc1_origins = [
  {
...
nonprod_euc1_cache_policy_id            = "658327ea-f89d-4fab-a63d-7e88639e58f6"
nonprod_euc1_response_headers_policy_id = "1a3788e6-d628-4eff-8bf4-5796dc64f23e"
nonprod_euc1_custom_error_responses = [
  {
    error_code            = 403
...
nonprod_euc1_logging_prefix = "cloudfront/dash"

nonprod_euw2_enabled             = true
nonprod_euw2_comment             = "nonprod-euw2"
nonprod_euw2_aliases             = ["sg-nonprod-euw2.qa.stackguardian.io"]
nonprod_euw2_default_root_object = "index.html"
...
nonprod_euw2_custom_error_responses = [
  {
    error_code            = 403
    error_caching_min_ttl = 10
    response_code         = 200
